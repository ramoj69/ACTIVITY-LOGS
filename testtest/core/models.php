...
function insertUser($pdo, $first_name, $last_name, $gender, $product, $company) {
    $sql = "INSERT INTO veterinary (first_name, last_name, gender, product, company) 
            VALUES (?, ?, ?, ?, ?)";
    $stmt = $pdo->prepare($sql);
    $executeQuery = $stmt->execute([$first_name, $last_name, $gender, $product, $company]);
...
function editUser($pdo, $first_name, $last_name, $gender, $product, $company, $id) {
    $sql = "UPDATE veterinary
            SET first_name = ?, last_name = ?, gender = ?, product = ?, company = ?
            WHERE id = ?";
    $stmt = $pdo->prepare($sql);
    $executeQuery = $stmt->execute([$first_name, $last_name, $gender, $product, $company, $id]);
