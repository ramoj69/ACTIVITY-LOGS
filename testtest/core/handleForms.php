...
if (isset($_POST['insertUserBtn'])) { $first_name = trim($_POST['first_name']); $last_name = trim($_POST['last_name']); $gender = trim($_POST['gender']);
	$specialization = trim($_POST['product']); $years_of_experience = trim($_POST['company']);
    if (!empty($first_name) && !empty($last_name) && !empty($gender) && !empty($specialization) && !empty($years_of_experience)){
        $insertUser = insertUser($pdo,$_POST['first_name'], $_POST['last_name'],  $_POST['gender'], $_POST['product'], $_POST['company']);
...
if (isset($_POST['editUserBtn'])) {
	...
	$editUser = editUser($pdo,$_POST['first_name'], $_POST['last_name'], $_POST['gender'],  $_POST['product'], $_POST['company'], $_GET['id']);
